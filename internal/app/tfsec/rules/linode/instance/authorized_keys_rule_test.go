...
func Test_LinodeInstanceAuthorizedKeys_FailureExamples(t *testing.T) {
	expectedCode := "linode-instance-authorized-keys"
...
func Test_LinodeInstanceAuthorizedKeys_SuccessExamples(t *testing.T) {
	expectedCode := "linode-instance-authorized-keys"
